          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto align-items-center">
              ...
              <li className="nav-item ms-lg-4 d-flex align-items-center mt-4 mt-lg-0 pb-2 pb-lg-0">
                ...
                <button className="btn btn-warning rounded-pill px-4 ms-3 fw-bold shadow-sm" data-bs-toggle="modal" data-bs-target="#modalApoyo">
                  Apoyarnos 🤎
                </button>
              </li>
            </ul>
  ...
  return (
    <main>
      <section className="container text-center py-5">
        <h1 className="display-3 fw-bolder mb-3">No estás solo ❤️</h1>
        <p className="lead mb-4">Tu espacio premium de apoyo y comprensión para Esclerosis Múltiple.</p>
        <div className="video-wrapper mx-auto shadow rounded-4 overflow-hidden" style={{ maxWidth: 880 }}>
      ...
      <section className="container text-center">
        <h2>Bienvenido a EMpaticos</h2>
        <p>
          Compartimos historias reales, noticias y esperanza.
          <br />Explorá nuestras secciones y sentite parte de una gran familia.
        </p>
        <div className="mt-5 d-flex flex-column flex-sm-row justify-content-center gap-3">
          <NavLink to="/unirme" className="btn btn-warning btn-lg px-4">Compartir mi historia</NavLink>
          <NavLink to="/historias" className="btn btn-outline-warning btn-lg px-4">Leer testimonios</NavLink>
        </div>
      </section>
    </main>
  );
          ...
          <div className="card shadow p-4 rounded-4">
            <form onSubmit={handleSubmit}>
              ...
              <div className="text-center">
                <button type="submit" className="btn btn-warning btn-lg px-5" disabled={sending}>
          ...
          <div className="col-md-5">
            <div className="card shadow-sm rounded-4 border-0 p-4">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className="btn btn-warning btn-lg w-100 fw-bold">Entrar de forma segura</button>
              </form>
