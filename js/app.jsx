          ...
          <div className="row align-items-center">
            <div className="col-lg-7">
              ...
              <div className="d-flex flex-column flex-sm-row gap-3">
                <NavLink to="/unirme" className="btn btn-light btn-lg fw-bold shadow-sm">Compartir mi historia</NavLink>
                <NavLink to="/historias" className="btn btn-outline-light btn-lg fw-bold">Leer testimonios</NavLink>
              </div>
            </div>
