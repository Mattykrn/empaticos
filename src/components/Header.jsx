        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto align-items-center">
              ...
              <li className="nav-item ms-xl-4 d-flex align-items-center mt-4 mt-xl-0 pb-2 pb-xl-0 flex-wrap gap-2">
                <div className="gtranslate_wrapper me-2"></div>
                <a
                ...
                <NavLink to="/perfil" className="btn btn-outline-light btn-sm fw-bold rounded-pill px-3" title="Mi perfil">
                  {profile.avatar ? <span aria-hidden="true">{profile.avatar}</span> : '👤'}
                  <span className="ms-1 d-none d-lg-inline">{displayName}</span>
                </NavLink>
                <button className="btn btn-light btn-sm fw-bold rounded-pill px-3" onClick={openModal} title="Editar perfil">
                  Editar perfil
                </button>
                <ThemeToggle darkMode={darkMode} onToggle={onToggleTheme} />
                <button className="btn btn-warning rounded-pill px-4 ms-1 fw-bold shadow-sm btn-glow" data-bs-toggle="modal" data-bs-target="#modalApoyo">
                  Apoyarnos 🤎
                </button>
              </li>
            </ul>
